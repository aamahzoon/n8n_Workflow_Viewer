...
<div id="{component_id}" class="n8nv-root">
  <style>
    ...
    #{component_id} .n8nv-toolbar {{
      ...
      border-radius: 10px; padding: 6px 10px; box-shadow: 0 2px 10px rgba(0,0,0,.35);
    }}
    #{component_id} .n8nv-toolbar input[type=text] {{
      background: #14161b; border: 1px solid var(--panel-border); color: var(--text-main);
      border-radius: 6px; padding: 5px 8px; font-size: 12.5px; width: 170px; outline: none;
    }}
    #{component_id} .n8nv-toolbar button {{
      background: #2a2f38; border: 1px solid var(--panel-border); color: var(--text-main);
      border-radius: 6px; width: 26px; height: 26px; cursor: pointer; font-size: 14px;
    }}
    #{component_id} .n8nv-toolbar button:hover {{ background: #343a45; }}
    #{component_id} .n8nv-cat-panel {{
      position: absolute; top: 58px; left: 12px; z-index: 20;
      background: var(--panel-bg); border: 1px solid var(--panel-border);
      border-radius: 10px; padding: 8px 10px; box-shadow: 0 2px 10px rgba(0,0,0,.35);
      max-height: 260px; overflow-y: auto; font-size: 12px; color: var(--text-dim);
    }}
    #{component_id} .n8nv-cat-panel label {{
      display: flex; align-items: center; gap: 6px; padding: 2px 0; cursor: pointer; white-space: nowrap;
    }}
    ...
    #{component_id} .n8nv-node .box {{
      ...
      background: #2b2f38; border: 2px solid #3d4350; border-radius: 12px;
      display: flex; align-items: center; justify-content: center; font-size: 30px;
      box-shadow: 0 2px 6px rgba(0,0,0,.4); position: relative; transition: border-color .12s, box-shadow .12s;
    }}
    ...
    #{component_id} .n8nv-node .label {{
      margin-top: 6px; font-size: 11.5px; color: var(--text-main); text-align: center;
      max-width: 110px; line-height: 1.25; text-shadow: 0 1px 3px rgba(0,0,0,.8);
    }}
    ...
    #{component_id} .n8nv-port {{
      ...
      background: #6b7280; border: 2px solid var(--bg); top: 50%; transform: translateY(-50%);
    }}
    ...
    #{component_id} .n8nv-sticky {{
      position: absolute; background: rgba(245,215,110,.14); border: 1px solid rgba(245,215,110,.4);
      border-radius: 8px; padding: 10px 12px; color: #f5d76e; font-size: 12px;
    ...
    #{component_id} .n8nv-panel pre {{
      background: #14161b; border: 1px solid var(--panel-border); border-radius: 6px;
      padding: 8px; font-size: 11px; overflow-x: auto; color: #c9d1d9; white-space: pre-wrap; word-break: break-word;
    }}
